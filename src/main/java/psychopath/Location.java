...
public abstract class Location<Self extends Location> {
     ...
     * precision supported by the file system. Converting from finer to coarser granularities result in
     * precision loss. The behavior of this method when attempting to set the last modified time when it
     * is not supported by the file system or is outside the range supported by the underlying file
     ...
     * @throws IOException if an I/O error occurs
     * @throws SecurityException In the case of the default provider, and a security manager is
     *             installed, its {@link SecurityManager#checkWrite(String) checkWrite} method denies
    ...
    /**
     * Shorthand method for <code>moveTo(parent())</code>.
     */
