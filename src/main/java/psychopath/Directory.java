...
public class Directory extends Location<Directory> {
     ...
     */
    public Signal<Ⅱ<Directory, File>> files(String... patterns) {
     ...
     * @return All matched directories. (<em>not</em> including file)
     */
    public Signal<Ⅱ<Directory, File>> files(int depth, String... patterns) {
     ...
     * @return All matched directories. (<em>not</em> including file)
     */
    public Signal<Ⅱ<Directory, File>> files(BiPredicate<Path, BasicFileAttributes> filter) {
     ...
     * @return All matched directories. (<em>not</em> including file)
     */
    public Signal<Ⅱ<Directory, File>> files(int depth, BiPredicate<Path, BasicFileAttributes> filter) {
        return new Signal<File>((observer, disposer) -> {
            try {
